                        ...
                        @foreach($categories as $category)
                            <div class="category category-classic category-absolute overlay-zoom br-xs mb-2">
                                ...
                                <div class="category-content">
                                    ...
                                    <a href="{{ route('category.products', [$category->id, Str::slug($category->title)]) }}" style="text-decoration: none" class="btn btn-primary btn-link btn-underline">{{ $category->title }}</a>
                                </div>
                            </div>
                            @endforeach
                    </div>
