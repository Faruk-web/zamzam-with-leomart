                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $wishlist->product->title }}</td>
                                        <td><img src="{{ asset($wishlist->product->image) }}" style="height: 80px; width: 80px"></td>
                                        <td>
                                        <form action="{{ route('wishlist.remove', $wishlist->id) }}" method="POST">
                                            @csrf
                                            <button onclick="addToCart({{ $wishlist->product->id }})" type="submit" class="btn btn-rounded btn-dark" style="color: #fff;">Add To Cart</button>
                                            <button type="submit" class="btn btn-rounded btn-dark"><i class="fas fa-times"></i></button>
                                        </form>
                                        </td>
                                    </tr>
                                    @endforeach
