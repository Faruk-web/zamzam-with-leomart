                                ...
                                <div class="row">
                                    <div class="form-group col-md-9">
                                        <div  class="form-check form-check-inline my-checkbox">
                                            <input class="form-check-input group1" id="wholesale" type="checkbox" name="wholesale" value="1" value="1" style="height: 30px; width: 20px" >
...
@else
    <form action="{{ route('vendor.product.update1') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="container-fluid">
            <div class="card-header mb-3">
                <div class="row">
