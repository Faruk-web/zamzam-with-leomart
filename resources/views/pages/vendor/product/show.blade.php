        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('vendor.product') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add Product</a>
                </div>
                <!-- /.card-header -->
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>{{ $product->type }}</td>
                                <td><span class="badge badge-{{ $product->is_active == 1 ? 'success' : 'warning' }}">{{ $product->is_active == 1 ? 'Active' : 'Pending' }}</span></td>
                                <td>
