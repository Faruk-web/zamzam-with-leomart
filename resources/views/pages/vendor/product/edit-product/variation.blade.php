@php
    $submission = \App\Models\Product::where('submission', $product->id)->first();
@endphp
...
@if($submission == true)
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('vendor.product.edit.update4')}}" id="variantForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
