                                ...
                                <div class="card card-primary card-tabs">
                                    <div class="card-header p-0 pt-1">
                                        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                            ...
                                            @endphp
                                            @php
                                                $wholesale = \App\Models\Product::where('id', $product->id)->where('wholesale', 1)->first();
                                            @endphp
                                            <li class="nav-item">
                                            ...
                                            @if($submission == true)
                                                ...
                                                @if($wholesale == true)
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ session('activeTab') == 'custom-tabs-two-aaa' ? 'active' : '' }}" id="custom-tabs-two-aaa-tab" data-toggle="pill" href="#custom-tabs-two-aaa" role="tab" aria-controls="custom-tabs-two-aaa" aria-selected="false">Wholesale, Price, Stock</a>
                                                    </li>
                                                @else
                                                    <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                            <div class="tab-pane fade {{ session('activeTab') == 'custom-tabs-two-home' ? 'show active' : '' }}" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                                                @include('pages.vendor.product.edit-product.basic')
                                            </div>
                                            <div class="tab-pane fade {{ session('activeTab') == 'custom-tabs-two-profile' ? 'show active' : '' }}" id="custom-tabs-two-profile" role="tabpanel" aria-labelledby="custom-tabs-two-profile-tab">
                                                @include('pages.vendor.product.edit-product.description')
                                            </div>
                                            <div class="tab-pane fade {{ session('activeTab') == 'custom-tabs-two-aaa' ? 'show active' : '' }}" id="custom-tabs-two-aaa" role="tabpanel" aria-labelledby="custom-tabs-two-aaa-tab">
                                                @include('pages.vendor.product.edit-product.wholesale')
                                            </div>
                                            <div class="tab-pane fade {{ session('activeTab') == 'custom-tabs-two-messages' ? 'show active' : '' }}" id="custom-tabs-two-messages" role="tabpanel" aria-labelledby="custom-tabs-two-messages-tab">
                                                @include('pages.vendor.product.edit-product.variation')
                                            </div>
                                            <div class="tab-pane fade {{ session('activeTab') == 'custom-tabs-two-settings' ? 'show active' : '' }}" id="custom-tabs-two-settings" role="tabpanel" aria-labelledby="custom-tabs-two-settings-tab">
                                                @include('pages.vendor.product.edit-product.service')
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card -->
