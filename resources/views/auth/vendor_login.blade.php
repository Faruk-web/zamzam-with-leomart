    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-6">
            <div class="card h-100" style="background-color: #bddbd1">
                <div class="card-header" style="font-size: 25px;text-align: center;">{{ __('Vendor Login') }}</div>
                <div class="card-body">
                    <h3 class="text-center">Multi vendor service marketplace</h3>
                    <form method="POST" action="{{ route('vendor.login.store') }}" style="margin-top: 10%;">
                        @csrf
                ...
                <div class="mt-5 text-center mb-5">
                    <div>
                        <p>Don't have an account ? <a href="{{route('vendor.register')}}" class="fw-medium text-primary"> Register</a> </p>
