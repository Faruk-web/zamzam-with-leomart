                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
	                  @foreach($sidebars as $sidebar)
	                  	<tr>
		                    <td>{{ $loop->index + 1 }}</td>
		                    <td>{{ $sidebar->main_sidebar }}</td>
                            <td>{{ $sidebar->childe_sidebar }}</td>
                    
		                    <td>
		                    	<a href="#editModal{{ $sidebar->id }}" class="btn btn-primary" data-toggle="modal" title="Edit"><i class="fas fa-edit"></i></a>
		                    	<a href="#deleteModal{{ $sidebar->id }}" class="btn btn-danger" data-toggle="modal" title="Delete"><i class="fas fa-trash"></i></a>
		                    </td>
		                </tr>
