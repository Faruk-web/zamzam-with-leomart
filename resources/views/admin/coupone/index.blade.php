...
{{--                          <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" required>--}}
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Voucher/Coupon Type *</label>
                          <select name="coupon_type" class="form-control @error('coupon_type') is-invalid @enderror" required>
                            <option selected disabled>Select Voucher/Coupon Type </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="" class="form-control">
                                                ...
                                                <option value="coupon" {{ $coupon->type == 'coupon' ? 'selected' : '' }}>Coupon</option>
                                            </select>
                                            {{--                          <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" required>--}}
                                            @error('code')
                                            <span class="invalid-feedback" role="alert">
