...
<div class="container-fluid">
    <form action="{{ route('product.update-3') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card mt-5">
            <div class="card-body">
                <div class="row">
        ...
        <div class="card mt-5">
            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="row">
                        @php
                            $cross_border = \App\Models\Product::where('id', $product->id)->where('cross_border', 1)->first();
                        @endphp
                        ...
                        @endif
                        @php
                            $pre_order = \App\Models\Product::where('id', $product->id)->where('pre_order', 1)->first();
                        @endphp
                        @if($pre_order == true)
