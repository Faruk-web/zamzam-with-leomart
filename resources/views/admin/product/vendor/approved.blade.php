...
{{--                       </td>--}}
		                    ...
		                    <td>
                                ...
                                <a href="#approvedModal{{ $product->id }}" class="btn btn-warning"  data-toggle="modal" title="Reject"><i class="fas fa-ban"></i></a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal fade" id="approvedModal{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Are you sure want to Reject ?</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{ route('product.vendor.update', $product->id) }}" method="POST">
                                            @csrf
                                            <button type="submit" name="is_active" value="0" class="btn btn-success float-right">Yes</button>
