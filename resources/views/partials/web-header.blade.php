        ...
        <div class="container">
            <div class="header-left mr-md-4 ">
                ...
                <a href="{{ route('index') }}" class="logo ml-lg-0 " style="text-decoration: none;">
                    <img class="faruk_logo" src="{{ asset('images/website/'.$business->logo) }}" alt="logo" width="144" height="45" />
                </a>
...
{{--                </div>--}}
                @if(Auth::check())
                    ...
                    @if(Auth::user()->type == 2)
                        <div class="header-call d-none d-md-flex">
                            <h5 class="mb-0 d-none d-md-flex"> <i class="w-icon-account"></i>  <a href="{{ route('vendor.desboard') }}" class="" style="text-decoration: none;">&nbsp;Vendor Account</a></h5>
                        </div>
                            <h5 class="mb-0 d-none d-md-flex"> <i class="w-icon-logout"></i> <a href="{{ route('logout') }}" class=""
                                                 onclick="event.preventDefault();
                               document.getElementById('logout-form').submit();" style="text-decoration: none;">&nbsp;Logout</a></h5>
                    @elseif(Auth::user()->type == 1)
                        <div class="header-call d-none d-md-flex">
                        <h5 class="mb-0 d-none d-md-flex"> <i class="w-icon-account"></i> <a href="{{ route('home') }}" class="" style="text-decoration: none;">&nbsp;Admin Account</a></h5>
                        </div>
                        <h5 class="mb-0 d-none d-md-flex"><i class="w-icon-logout"></i> <a href="{{ route('logout') }}" class=""
                                            onclick="event.preventDefault();
                               document.getElementById('logout-form').submit();" style="text-decoration: none;">&nbsp;Logout</a></h5>
                    @else
                        <div class="header-call d-none d-md-flex">
                        <h5 class="mb- d-none d-md-flex0"> <i class="w-icon-account"></i> <a href="{{ route('customer.account') }}" class="" style="text-decoration: none;">&nbsp;Customer Account</a></h5>
                        </div>
                        <h5 class="mb-0 d-none d-md-flex"><i class="w-icon-logout"></i> <a href="{{ route('logout') }}" class=""
                                            onclick="event.preventDefault();
                               document.getElementById('logout-form').submit();" style="text-decoration: none;">&nbsp;Logout</a></h5>
                ...
                @else
                    <div class="header-call d-none d-md-flex">
                   <h5 class="mb-0 d-none d-md-flex"> <a id="sing-in-a" href="{{ route('login') }}" class="" style="text-decoration: none;">
